	...
	return (
		<div className='grid grid-cols-6 gap-10 w-full mb-10'>
			<div className='col-span-6 md:hidden flex justify-center items-center'>
				<img src='Paul-2.jpg' alt='Photo' className='w-full lg:hidden' />
			</div>
			...
			<div className='md:col-span-4 col-span-6 md:mr-6'>
				<h2 className='text-2xl md:text-3xl font-bold mb-2'>Skill Summary</h2>
				<table className='w-full border-[1px] border-black mr-4 text-xl lg:text-2xl'>
